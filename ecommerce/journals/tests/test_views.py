...
class JournalBundleOfferListViewTests(ViewTestMixin, TestCase):
    ...
    def setUp(self):
        ...
        self.path = reverse('journals:offers:list')

    @mock.patch('ecommerce.journals.views.fetch_journal_bundle')
...
@mock.patch('ecommerce.journals.views.fetch_journal_bundle')
@mock.patch('ecommerce.journals.forms.fetch_journal_bundle')
...
class JournalBundleOfferCreateViewTests(ViewTestMixin, TestCase):
    ...
    path = reverse('journals:offers:new')
    ...
    def test_post(self, mock_discovery_call_post, mock_discovery_call_update):
        ...
        self.assertRedirects(response, reverse('journals:offers:edit', kwargs={'pk': journal_offer.pk}))
