...
from ecommerce.journals.constants import JOURNALS_API_PATH
...
class JournalTestCase(TestCase):
    """
    Base test case for ecommerce journals tests.

    This class guarantees that tests have a Site and Partner available.
    """
    def setUp(self):
        super(JournalTestCase, self).setUp()
        self.site_configuration.journals_api_url = 'https://journals.example.com/api/v1/'
...
class JournalClientTests(JournalTestCase):
    """ Test cases for the journals client.py """

    @responses.activate
    def test_get_journal_service_client(self):
        """ Test that 'get_journals_service_client' returns an EdxRestApiClient with the correct journals url
        and access token """
