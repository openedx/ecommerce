...
class AdyenTests(AdyenMixin, PaymentProcessorTestCaseMixin, TestCase):
    ...
    def test_payment_refused_creation_state(self):
        ...
        response = self.mock_payment_creation_response(payment_refused=True)
    ...
    def test_handle_processor_response_refused_payment(self):
        ...
        adyen_payment_response = self.mock_payment_creation_response(payment_refused=True)
    ...
    def test_handle_processor_response_error(self):
        ...
        """
        adyen_payment_response = self.mock_payment_creation_response(True, self.ADYEN_PAYMENT_INVALID_EVENT)
        ...
        adyen_payment_response = self.mock_payment_creation_response(True, self.ADYEN_PAYMENT_INVALID_RESPONSE)
    ...
    def test_issue_credit(self):
        ...
        adyen_refund_response = self.mock_refund_creation_response()
    ...
    def test_issue_credit_error(self):
        ...
        self.mock_refund_creation_response(True, self.ADYEN_REFUND_INVALID_RESPONSE)
        ...
        self.mock_refund_creation_response(True, self.ADYEN_REFUND_INVALID_RESPONSE, 400)
        with self.assertRaises(GatewayError):
