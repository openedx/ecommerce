...
from ecommerce.extensions.payment.processors.paypal.models import PaypalWebProfile
...
class Paypal(BasePaymentProcessor):
    ...
    CONFIGURATION_MODEL = 'ecommerce.extensions.payment.processors.paypal.models.PaypalConfiguration'
    DEFAULT_PROFILE_NAME = 'default'
    NAME = 'paypal'
    URLS_MODULE = 'ecommerce.extensions.payment.processors.paypal.urls'
    ...
    @property
    def error_url(self):
        return get_ecommerce_url(settings.ERROR_PAGE_PATH)
