...
from ecommerce.extensions.payment.processors.cybersource.exceptions import InvalidCybersourceDecision
...
class Cybersource(BasePaymentProcessor):
    ...
    CONFIGURATION_MODEL = 'ecommerce.extensions.payment.processors.cybersource.models.CybersourceConfiguration'
    NAME = 'cybersource'
    URLS_MODULE = 'ecommerce.extensions.payment.processors.cybersource.urls'
