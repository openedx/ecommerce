...
class CourseEntitlementFulfillmentModule(EnterpriseDiscountMixin, BaseFulfillmentModule):
    ...
    def supports_line(self, line):
        ...
        # fulfillment for Executive Education products will be handled separately
        return line.product.is_course_entitlement_product and certificate_type not in ['paid-executive-education']
