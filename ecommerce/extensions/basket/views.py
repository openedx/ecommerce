...
class PaymentApiLogicMixin(BasketLogicMixin):
    ...
    def _serialize_context(self, context, lines_data):
        ...
        self._add_enable_stripe_intents_payment_processor(response)
        return response
    ...
    def _add_enable_stripe_intents_payment_processor(self, response):
        response['enable_stripe_intents_payment_processor'] = waffle.flag_is_active(
            self.request, ENABLE_STRIPE_INTENTS_PAYMENT_PROCESSOR
        )
