...
class CouponCodeRemindSerializer(serializers.Serializer):  # pylint: disable=abstract-method
    ...
    def create(self, validated_data):
        ...
        """
        offer_assignments = validated_data.get('offer_assignments')
        code = validated_data.get('redeemed_offer_count')
        email = validated_data.get('total_offer_count')
        ...
        try:
            if template and offer_assignments:
