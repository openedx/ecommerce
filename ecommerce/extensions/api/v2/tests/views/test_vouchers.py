...
class VoucherViewSetTests(DiscoveryMockMixin, CourseCatalogTestMixin, LmsApiMockMixin, TestCase):
    ...
    def prepare_get_offers_response(self, quantity=1, seat_type='verified', seats=None):
        ...
        self.mock_course_runs_endpoint(query='*:*', course_run_info=course_run_info)
...
class VoucherViewOffersEndpointTests(DiscoveryMockMixin, CouponMixin, CourseCatalogTestMixin, LmsApiMockMixin,
    ...
    def test_voucher_offers_listing_catalog_query_exception(self, return_value, method):
        ...
        toggle_switch('use_multi_tenant_discovery_api_urls', True)
        course, seat = self.create_course_and_seat()
        self.mock_course_runs_endpoint(query='*:*', course_run=course)
    ...
    def test_get_offers_for_course_catalog_voucher(self):
        ...
        self.mock_catalog_detail_endpoint(catalog_id=catalog_id, expected_query=catalog_query)
