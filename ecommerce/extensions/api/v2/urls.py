...
RETIREMENT_URLS = [
    re_path(r'^tracking_id/{}/$'.format(USERNAME_PATTERN), retirement_views.EcommerceIdView.as_view(),
            name='tracking_id')
]
...
ENTERPRISE_URLS = [
    ...
    path('customer_catalogs', enterprise_views.EnterpriseCustomerCatalogsViewSet.as_view({'get': 'get'}),
         name='enterprise_customer_catalogs'
         ),
    path('customer_catalogs/<str:enterprise_catalog_uuid>',
