...
@ddt.ddt
class AddCourseOrganizationCommandTests(CourseCatalogTestMixin, TestCase):
    """Tests the add course organization."""

    def setUp(self):
        super(AddCourseOrganizationCommandTests, self).setUp()
    ...
    def test_add_course_organization(self):
        ...
        self.assertEqual(course.organization, None)
