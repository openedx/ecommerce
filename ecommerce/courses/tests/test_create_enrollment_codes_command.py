...
class CreateEnrollmentCodesTests(DiscoveryTestMixin, TransactionTestCase):
    ...
    def test_invalid_file_path(self):
        ...
        with self.assertRaises(CommandError):
            call_command('create_enrollment_codes', course_ids_file="invalid/courses_id/file/path", batch_sleep_time=0)
    ...
    def test_invalid_course_id(self):
        ...
        with LogCapture(LOGGER_NAME) as log_capture:
            call_command('create_enrollment_codes', course_ids_file=self.tmp_file_path, batch_sleep_time=0)
    ...
    def test_create_enrollment_codes_skips_courses_with_already_an_enrollment_code(self):
        ...
        call_command('create_enrollment_codes', batch_sleep_time=0)
