            ...
            initialize: function () {
                ...
                this.listenTo(providerSelectionView, 'productSelected', function (data) {
                    ...
                    if (data.discount === 'None') {
                        this.$el.find('span.total-price').text(data.price);
                    } else {
                        this.$el.find('span.price').text(data.price);
                        this.$el.find('span.discount').text(data.discount);
                        this.$el.find('span.total-price').text(data.new_price);
                    }
                });
