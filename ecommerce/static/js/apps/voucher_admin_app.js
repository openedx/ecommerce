require([
    ...
    function (Backbone,
        ...
        navigate = function (event) {
            var url = $(this).attr('href').replace(voucherApp.root, '');
            ...
            if (url === Backbone.history.getFragment() && url === '') {
                ...
                voucherApp.navigate(url, {trigger: true});
            }
        };
        ...
        Backbone.View.prototype.goTo = function (fragment) {
            voucherApp.navigate(fragment, {trigger: true});
        };

        $(function () {
            var $app = $('#app');

            voucherApp = new VoucherRouter({$el: $app});
            voucherApp.start();
