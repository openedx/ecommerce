define([
        ...
        'backbone.super',
        'pages/enrollment_codes_list_page',
        'pages/enrollment_codes_create_page'
    ],
    function (Backbone,
              BackboneRouteFilter,
              BackboneSuper,
              EnrollmentCodesListPage,
              EnrollmentCodesCreatePage) {
        'use strict';
        ...
        return Backbone.Router.extend({
            ...
            /**
             * Display a list of all vouchers in the system.
             */
            index: function () {
                var page = new EnrollmentCodesListPage();
                this.currentView = page;
                this.$el.html(page.el);
            },

            /**
             * Display a form for creating a new voucher.
             */
            new: function () {
                var page = new EnrollmentCodesCreatePage();
                this.currentView = page;
                this.$el.html(page.el);
            }
        });
