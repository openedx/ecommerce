define([
        ...
        'backbone.super',
        'pages/enrollment_code_list_page',
        'pages/enrollment_code_create_page'
    ],
    function (Backbone,
              BackboneRouteFilter,
              BackboneSuper,
              EnrollmentCodeListPage,
              EnrollmentCodeCreatePage) {
        'use strict';
        ...
        return Backbone.Router.extend({
             ...
             */
            index: function () {
                var page = new EnrollmentCodeListPage();
             ...
             */
            new: function () {
                var page = new EnrollmentCodeCreatePage();
                this.currentView = page;
                this.$el.html(page.el);
            }
        });
