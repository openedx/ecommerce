...
class EnterpriseOfferListView(EnterpriseOfferViewMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        context = super(EnterpriseOfferListView, self).get_context_data(**kwargs)

        # TODO: Optimize our API calls, pulling the enterprise data in as few calls as possible.
        offers = []
        for offer in context['object_list']:
            offer.enterprise_customer = get_enterprise_customer(
                self.request.site,
