...
class SendEnterpriseOfferLimitEmailsTests(TestCase):
    ...
    def setUp(self):
        ...
        self.offer_with_enrollment_limit = EnterpriseOfferFactory(max_global_applications=10)
        self.offer_with_booking_limit = EnterpriseOfferFactory(max_discount=100)
    ...
    def test_command(self):
        ...
        with mock.patch('ecommerce_worker.sailthru.v1.tasks.send_offer_assignment_email.delay') as mock_send_email:
        ...
        log.check(
            (
                ...
                '[Offer Usage Alert] Total count of enterprise offers is {total_enterprise_offers_count}.'.format(
                    total_enterprise_offers_count=5
                )
            ),
            (
                LOGGER_NAME,
