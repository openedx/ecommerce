...
from ecommerce.enterprise.constants import BENEFIT_MAP, BENEFIT_PROXY_CLASS_MAP, BENEFIT_TYPE_CHOICES
...
class EnterpriseOfferForm(forms.ModelForm):
    ...
    def save(self, commit=True):
        ...
        offer_name = _(u"Discount for {enterprise_name}'s Catalog with UUID [{catalog_uuid}]".format(
            enterprise_name=enterprise_customer['name'],
            catalog_uuid=enterprise_customer_catalog_uuid  # TODO: use the catalog title in the future.
        ))
