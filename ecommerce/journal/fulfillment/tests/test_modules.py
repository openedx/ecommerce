...
from ecommerce.journal.fulfillment.modules import JournalFulfillmentModule
...
class JournalFulfillmentModuleTest(TestCase, JournalMixin):
    ...
    @mock.patch("ecommerce.journal.fulfillment.modules.post_journal_access")
    ...
    @mock.patch("ecommerce.journal.fulfillment.modules.post_journal_access", mock.Mock(side_effect=ConnectionError))
    ...
    @mock.patch("ecommerce.journal.fulfillment.modules.post_journal_access", mock.Mock(side_effect=Exception))
